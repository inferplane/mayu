...
const MSG = {
  ...
  "prov.newProvider": { en: "NEW PROVIDER", ko: "새 프로바이더", zh: "新建提供方", ja: "新規プロバイダー" },
  "prov.newModel": { en: "NEW MODEL", ko: "새 모델", zh: "新建模型", ja: "新規モデル" },
  "prov.dataBoundary": { en: "Data boundary", ko: "데이터 경계", zh: "数据边界", ja: "データ境界" },
  "prov.boundaryUnknown": { en: "unknown", ko: "알 수 없음", zh: "未知", ja: "不明" },
  "prov.boundaryInternal": { en: "internal", ko: "내부", zh: "内部", ja: "内部" },
  "prov.boundaryExternal": { en: "external", ko: "외부", zh: "外部", ja: "外部" },
  "prov.contextWindow": { en: "Context window · input + output tokens (blank / 0 = unknown)", ko: "컨텍스트 윈도 · 입력 + 출력 토큰 (빈칸 / 0 = 알 수 없음)", zh: "上下文窗口 · 输入 + 输出令牌（空白 / 0 = 未知）", ja: "コンテキストウィンドウ · 入力 + 出力トークン（空欄 / 0 = 不明）" },
  "prov.capabilities": { en: "Declared capabilities · uncheck all to clear", ko: "선언된 기능 · 모두 해제하면 초기화", zh: "声明的能力 · 全部取消勾选以清除", ja: "宣言された機能 · すべてのチェックを外すとクリア" },
  "prov.capTools": { en: "Tools", ko: "도구", zh: "工具", ja: "ツール" },
  "prov.capVision": { en: "Vision", ko: "이미지 이해", zh: "视觉", ja: "画像理解" },
  "prov.capReasoning": { en: "Reasoning", ko: "추론", zh: "推理", ja: "推論" },
  "prov.capStructuredOutput": { en: "Structured output", ko: "구조화된 출력", zh: "结构化输出", ja: "構造化出力" },
  "prov.invalidContext": { en: "Context window must be a nonnegative safe integer.", ko: "컨텍스트 윈도는 안전한 범위의 음이 아닌 정수여야 합니다.", zh: "上下文窗口必须为安全范围内的非负整数。", ja: "コンテキストウィンドウは安全な範囲の非負整数で指定してください。" },
  "prov.editUnavailable": { en: "Provider is no longer available. Refresh the provider list.", ko: "프로바이더를 찾을 수 없습니다. 목록을 새로 고치세요.", zh: "提供方已不可用。请刷新列表。", ja: "プロバイダーが見つかりません。一覧を更新してください。" },
